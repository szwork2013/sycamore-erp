	...
	render: function() {
		...
		return (
			<Layout pageTitle={pageTitle} locals={this.props.locals}>
				<form action={this.props.locals.applicationUrl + "product"} encType="application/x-www-form-urlencoded" method="POST">
						...
						<TabPanel>
							<div className="row">
								<div className="large-6 columns">
									<Product product={this.props.locals.product} editable={true} isNew={true} />
								</div>
							</div>
						</TabPanel>
					</Tabs>
