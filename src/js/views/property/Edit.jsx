...
var View = React.createClass({
	getInitialState: function() {
		...
		var state = {
			...
			locals: locals,
			menus: [],
			title: "Sycamore ERP - Edit property"
		};
	...
	render: function() {
		return (
			<Layout title={this.state.title} locals={this.props.locals}>
				...
				<form action={"/sycamore-erp/property/" + this.state.locals.property._id} encType="application/x-www-form-urlencoded" method="POST">
					<div className="row">
