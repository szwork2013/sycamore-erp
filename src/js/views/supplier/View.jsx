...
var View = React.createClass({
	...
	render: function() {
		var pageTitle = "View supplier";

		return (
			<Layout pageTitle={pageTitle} locals={this.props.locals}>
				<ActionsBar pageTitle={pageTitle}>
					<a href={"/sycamore-erp/supplier/" + this.props.locals.supplier._id + "/edit.html"} className="right fancy radius button tiny">
						<i className="in-button-icon fa fa-fw fa-plus"></i> Edit
					</a>
				</ActionsBar>
				<div className="row">
