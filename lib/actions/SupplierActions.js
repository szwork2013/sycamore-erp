...
var SupplierActions = {
	...
	saveSupplier: function saveSupplier(supplier) {
		if (typeof supplier._id != "undefined" && supplier._id != null) {
			// POST
			Api.postSupplier(supplier._id, supplier, function (response) {
				AppDispatcher.handleViewAction({
			...
			// PUT
			Api.putSupplier(supplier, function (response) {
				AppDispatcher.handleViewAction({
					actionType: SupplierConstants.UPDATE_SUPPLIER,
					supplier: response.body
				});
	...
	updateSupplierBillingAddressLine1: function updateSupplierBillingAddressLine1(event) {
		AppDispatcher.handleViewAction({
			actionType: SupplierConstants.UPDATE_SUPPLIER_BILLING_ADDRESS_LINE1,
			line1: event.target.value
		});
	},
	updateSupplierBillingAddressLine2: function updateSupplierBillingAddressLine2(event) {
		AppDispatcher.handleViewAction({
			actionType: SupplierConstants.UPDATE_SUPPLIER_BILLING_ADDRESS_LINE2,
			line2: event.target.value
		});
	},
	updateSupplierBillingAddressLine3: function updateSupplierBillingAddressLine3(event) {
		AppDispatcher.handleViewAction({
			actionType: SupplierConstants.UPDATE_SUPPLIER_BILLING_ADDRESS_LINE3,
			line3: event.target.value
		});
	},
	updateSupplierBillingAddressLine4: function updateSupplierBillingAddressLine4(event) {
		AppDispatcher.handleViewAction({
			actionType: SupplierConstants.UPDATE_SUPPLIER_BILLING_ADDRESS_LINE4,
			line4: event.target.value
		});
	},
	updateSupplierBillingAddressPostCode: function updateSupplierBillingAddressPostCode(event) {
		AppDispatcher.handleViewAction({
			actionType: SupplierConstants.UPDATE_SUPPLIER_BILLING_ADDRESS_POSTCODE,
			postCode: event.target.value
		});
	},
	updateSupplierTelephone: function updateSupplierTelephone(event) {
		AppDispatcher.handleViewAction({
			actionType: SupplierConstants.UPDATE_SUPPLIER_TELEPHONE,
			telephone: event.target.value
		});
	},
	updateSupplierEmail: function updateSupplierEmail(event) {
		AppDispatcher.handleViewAction({
