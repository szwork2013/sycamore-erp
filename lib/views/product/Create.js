...
var View = React.createClass({
	...
	handleSupplierAsyncOptions: function handleSupplierAsyncOptions(input, callback) {
		callback(null, {
	...
	handleSupplierOnInputChange: function handleSupplierOnInputChange(inputValue) {
							...
							React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										"div",
										{ className: "large-8 columns" },
										React.createElement(Select, { name: "product[supplier]",
