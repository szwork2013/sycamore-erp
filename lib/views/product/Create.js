...
var View = React.createClass({
	...
	handleSuppliersChange: function handleSuppliersChange(value) {
		console.log(value);
	},
							...
							React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										"div",
										{ className: "large-8 columns" },
										React.createElement(SuppliersSelect, { name: "product[supplier]", onChange: this.handleSuppliersChange })
									)
								)
							)
						)
