...
var View = React.createClass({
	...
	_onUpdate: function _onUpdate() {
		ApplicationActions.getProducts(ListStore.getQueryOptions());
	},
	...
	render: function render() {
		return React.createElement(
			...
			React.createElement(List, { list: this.props.locals.list, selectRow: this.selectRow, updateListener: this._onUpdate })
		);
	}
});
