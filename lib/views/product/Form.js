...
var View = React.createClass({
	...
	render: function render() {
		...
		return React.createElement(
			...
			React.createElement(
				"form",
				{ action: this.props.locals.applicationUrl + "product", encType: "application/x-www-form-urlencoded", method: "POST" },
				React.createElement(
					ActionsBar,
					{ pageTitle: pageTitle },
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								...
								React.createElement(Product, { product: this.props.locals.product, editable: true, isNew: true })
							)
						)
					)
				)
