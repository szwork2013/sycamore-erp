					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								"div",
								{ className: "large-2 columns" },
								React.createElement("input", { className: "right fancy radius button tiny", type: "button", value: "New", onClick: this.openModal })
							)
						),
						React.createElement(
							"div",
						...
						React.createElement(
							...
							React.createElement(
								...
								React.createElement(
									"div",
									{ className: "large-8 columns" },
									React.createElement("input", { type: "text", disabled: "disabled", value: order.customer.billingAddress.line1 })
								)
							),
							React.createElement(
								"div",
								...
								React.createElement(
									"div",
									{ className: "large-8 columns" },
									React.createElement("input", { type: "text", disabled: "disabled", value: order.customer.billingAddress.line2 })
								)
							),
							React.createElement(
								"div",
								...
								React.createElement(
									"div",
									{ className: "large-8 columns" },
									React.createElement("input", { type: "text", disabled: "disabled", value: order.customer.billingAddress.line3 })
								)
							),
							React.createElement(
								"div",
								...
								React.createElement(
									"div",
									{ className: "large-8 columns" },
									React.createElement("input", { type: "text", disabled: "disabled", value: order.customer.billingAddress.line4 })
								)
							),
							React.createElement(
								"div",
								...
								React.createElement(
									"div",
									{ className: "large-8 columns" },
									React.createElement("input", { type: "text", disabled: "disabled", value: order.customer.billingAddress.postCode })
								)
							)
						),
						React.createElement(
							...
							React.createElement(
								"div",
								{ className: "large-8 columns" },
								React.createElement("input", { type: "text", disabled: "disabled", value: order.customer.telephone })
							)
						),
						React.createElement(
							"div",
							...
							React.createElement(
								"div",
								{ className: "large-8 columns" },
								React.createElement("input", { type: "text", disabled: "disabled", value: order.customer.email })
							)
						)
					)
				),
