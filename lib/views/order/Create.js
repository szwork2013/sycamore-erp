...
var View = React.createClass({
	...
	handleProductQuantityChange: function handleProductQuantityChange(event) {
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								"a",
								{ className: "button tiny right radius fancy", onClick: this.handleAddProduct },
								"Add Product"
							)
						)
					)
							...
							this.state.order.products.map(function (product) {
								return React.createElement(
									...
									React.createElement(
										"div",
										{ className: "table-cell" },
										React.createElement("input", { type: "number", onChange: this.handleProductQuantityChange, value: product.quantity })
									),
									React.createElement(
										"div",
										{ className: "table-cell" },
