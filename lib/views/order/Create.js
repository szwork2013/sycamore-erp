...
var View = React.createClass({
	...
	render: function render() {
		...
		return React.createElement(
			...
			React.createElement(
				"form",
				{ action: "/sycamore-erp/order", method: "POST" },
				React.createElement(
					ActionsBar,
					{ pageTitle: pageTitle },
					React.createElement("input", { onClick: this.handleCreateOrder, type: "submit", className: "right fancy radius button tiny", value: "Create" })
				),
				React.createElement(
					"div",
					{ className: "row" },
