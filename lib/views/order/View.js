							...
							React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										...
										null,
										React.createElement("input", { type: "checkbox" }),
										" I acknowledge that agreeing to this order will result in me/my company being invoiced for this order and I will be under obligation to pay the invoice in full upon completion (delivery & installation) of the order."
									)
								)
							)
						)
