...
var View = React.createClass({
	...
	handleAgreeClick: function handleAgreeClick() {
		Api.postOrder(this.state.order._id, this.state.order, function (response) {
	...
	renderAgreeButton: function renderAgreeButton() {
		...
		if (order.status != "Accepted") {
			if (this.state.order.terms.orderCorrectAgreed && this.state.order.terms.propertyTidyAgreed && this.state.order.terms.noticeAgreed && this.state.order.terms.paymentAgreed) {
				...
				return React.createElement(
					"a",
					{ href: "#", className: "right fancy radius button tiny", disabled: true, style: { "background": "lightred", "color": "red" } },
					React.createElement("i", { className: "in-button-icon fa fa-fw fa-check" }),
					" Agree"
				);
			}
		...
		return React.createElement(
			...
			React.createElement(
							...
							React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										"label",
										null,
										React.createElement("input", { disabled: this.state.order.terms.orderCorrectAgreed, type: "checkbox", value: this.state.order.terms.orderCorrectAgreed, onChange: OrderActions.setOrderCorrect }),
							...
							React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										"label",
										null,
										React.createElement("input", { disabled: this.state.order.terms.propertyTidyAgreed, type: "checkbox", value: this.state.order.terms.propertyTidyAgreed, onChange: OrderActions.setPropertyTidy }),
							...
							React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										"label",
										null,
										React.createElement("input", { disabled: this.state.order.terms.noticeAgreed, type: "checkbox", value: this.state.order.terms.noticeAgreed, onChange: OrderActions.setNoticeAgreed }),
							...
							React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										"label",
										null,
										React.createElement("input", { disabled: this.state.order.terms.paymentAgreed, type: "checkbox", value: this.state.order.terms.paymentAgreed, onChange: OrderActions.setPaymentAgreed }),
				...
				React.createElement(
					...
					React.createElement(
						ActionsBar,
						{ pageTitle: "Please click the Agree button to confirm and agree your order." },
