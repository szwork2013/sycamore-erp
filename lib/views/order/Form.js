									...
									this.state.order.products.map(function (product, productIndex) {
										return React.createElement(
											...
											React.createElement(
												...
												React.createElement("input", { onChange: OrderActions.setProductName.bind(this, productIndex), type: "text", value: product.name, style: { "margin": 0 } })
											),
											React.createElement(
												"div",
												{ className: "table-cell large-1" },
										...
										React.createElement(
											...
											React.createElement(
												...
												React.createElement(
													...
													React.createElement("input", { type: "text", onChange: OrderActions.setSubTotal, value: this.state.order.subTotal, style: { "margin": 0 } })
												)
											)
										)
									),
										...
										React.createElement(
											...
											React.createElement(
												...
												React.createElement(
													"div",
													{ className: "large-9 columns" },
													React.createElement("input", { type: "text", onChange: OrderActions.setVAT, value: this.state.order.VAT, style: { "margin": 0 } })
												)
											)
										)
									),
										...
										React.createElement(
											...
											React.createElement(
												...
												React.createElement(
													"div",
													{ className: "large-9 columns" },
													React.createElement("input", { type: "text", onChange: OrderActions.setTotal, value: this.state.order.total, style: { "margin": 0 } })
												)
											)
										)
									)
