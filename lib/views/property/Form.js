...
var View = React.createClass({
	...
	render: function render() {
		...
		return React.createElement(
			...
			React.createElement(
				"form",
				{ action: this.props.locals.applicationUrl + "property", encType: "application/x-www-form-urlencoded", method: "POST" },
				React.createElement(
					ActionsBar,
					{ pageTitle: pageTitle },
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								...
								React.createElement(Property, { property: this.props.locals.property, editable: true, isNew: true })
							)
						)
					)
				)
