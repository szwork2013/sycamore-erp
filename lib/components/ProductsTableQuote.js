							...
							this.props.quote.products.map(function (product, productIndex) {
								return React.createElement(
									...
									React.createElement(
										"div",
										{ className: "table-cell" },
										React.createElement("input", { type: "number", onChange: QuoteActions.setProductQuantityOnQuote.bind(this, productIndex), value: product.quantity })
									),
									React.createElement(
										"div",
										{ className: "table-cell" },
